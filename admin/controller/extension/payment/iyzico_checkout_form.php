...
class ControllerExtensionPaymentIyzicoCheckoutForm extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('payment_iyzico_checkout_form', $this->request->post);
        ...
        if (isset($this->request->get['update_error'])) {
            ...
            $versionCheck = $this->model_extension_payment_iyzico_checkout_form->versionCheck(VERSION, $this->iyzico_version);
            ...
            if (!empty($versionCheck['version_status']) AND $versionCheck['version_status'] == '1') {
                ...
                $data['version_update_link'] = $this->url->link('extension/payment/iyzico_checkout_form/update', 'user_token=' . $this->session->data['user_token'] . "&version=$version_updatable", true);
            }
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/payment/iyzico_checkout_form', 'user_token=' . $this->session->data['user_token'], true),
            'separator' => ' :: '
        );

        $data['action'] = $this->url->link('extension/payment/iyzico_checkout_form', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=payment', true);

        $merchant_keys_name_array = array(
            'payment_iyzico_checkout_form_api_id_live',
            'payment_iyzico_checkout_form_secret_key_live',
            'payment_iyzico_checkout_form_order_status_id',
            'payment_iyzico_checkout_form_status',
            'payment_iyzico_checkout_form_sort_order',
            'payment_iyzico_checkout_form_form_class',
            'payment_iyzico_checkout_form_cancel_order_status_id'
        );
        ...
        if (isset($this->request->post['payment_iyzico_checkout_form_test'])) {
            $data['payment_iyzico_checkout_form_test'] = $this->request->post['payment_iyzico_checkout_form_test'];
        } else {
            $mode = $this->config->get('payment_iyzico_checkout_form_test');
            if (isset($mode) && $mode == 0) {
                $data['payment_iyzico_checkout_form_test'] = 0;
            } else {
                $data['payment_iyzico_checkout_form_test'] = 1;
            }
        }

        $this->load->model('localisation/order_status');
		
		if($data['payment_iyzico_checkout_form_order_status_id']==''){
		$data['payment_iyzico_checkout_form_order_status_id'] = $this->config->get('config_order_status_id');
			}
        ...
        $this->response->setOutput($this->load->view('extension/payment/iyzico_checkout_form', $data));
    }
    ...
    public function update() {
        ...
        if ($updated == 1) {
			$this->load->model('setting/setting');
			$iyzico_checkout_form_api_id_live=$this->config->get('payment_iyzico_checkout_form_api_id_live');
			$iyzico_checkout_form_secret_key_live=$this->config->get('payment_iyzico_checkout_form_secret_key_live');
			$iyzico_checkout_form_cancel_order_status_id=$this->config->get('payment_iyzico_checkout_form_cancel_order_status_id');	
			$iyzico_checkout_form_sort_order=$this->config->get('payment_iyzico_checkout_form_sort_order');	
			$iyzico_checkout_form_form_class=$this->config->get('payment_iyzico_checkout_form_form_class');	
			$iyzico_checkout_form_order_status_id=$this->config->get('payment_iyzico_checkout_form_order_status_id');
			$iyzico_checkout_form_status=$this->config->get('payment_iyzico_checkout_form_status');	
			$this->session->data['iyzico_update'] =1;
			$this->load->controller('extension/payment/' . 'iyzico_checkout_form' . '/uninstall');
			$this->load->controller('extension/payment/' . 'iyzico_checkout_form' . '/install');
			
			$this->config->set('payment_iyzico_checkout_form_api_id_live', $iyzico_checkout_form_api_id_live);
			$this->config->set('payment_iyzico_checkout_form_secret_key_live', $iyzico_checkout_form_secret_key_live);
			$this->config->set('payment_iyzico_checkout_form_cancel_order_status_id', $iyzico_checkout_form_cancel_order_status_id);
			$this->config->set('payment_iyzico_checkout_form_sort_order', $iyzico_checkout_form_sort_order);
			$this->config->set('payment_iyzico_checkout_form_form_class', $iyzico_checkout_form_form_class);
			$this->config->set('payment_iyzico_checkout_form_order_status_id', $iyzico_checkout_form_order_status_id);
			$this->config->set('payment_iyzico_checkout_form_status', $iyzico_checkout_form_status);
            ...
            $this->response->redirect($this->url->link('extension/payment/iyzico_checkout_form', 'user_token=' . $this->session->data['user_token'] . "&update_error=$updated", true));
        }
    }
    ...
    public function order() {
        ...
        return $this->load->view('extension/payment/iyzico_checkout_form_order', $data);
    }
    ...
    public function cancel() {
        ...
        try {
            ...
            $merchant_api_id = $this->config->get('payment_iyzico_checkout_form_api_id_live');
            $merchant_secret_key = $this->config->get('payment_iyzico_checkout_form_secret_key_live');
            ...
            $cancel_transaction_id = $this->model_extension_payment_iyzico_checkout_form->createOrderEntry($save_data_array);
            ...
            $this->model_extension_payment_iyzico_checkout_form->updateOrderEntry($update_data_array, $cancel_transaction_id);
    ...
    public function refund() {
        ...
        try {
            ...
            $refund_transaction_id = $this->model_extension_payment_iyzico_checkout_form->createOrderEntry($save_data_array);
            ...
            $this->model_extension_payment_iyzico_checkout_form->updateOrderEntry($update_data_array, $refund_transaction_id);
    ...
    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/payment/iyzico_checkout_form')) {
        ...
        foreach ($validation_array as $key) {
            if (empty($this->request->post["payment_iyzico_checkout_form_{$key}"])) {
    ...
    private function _addhistory($order_id, $order_status_id, $comment) {
        ...
        if (empty($api_login_data['user_token'])) {
            return false;
        }
		$token = $api_login_data['user_token'];
