...
class ControllerExtensionPaymentIyzicoCheckoutForm extends Controller {
    ...
    public function index() {
        ...
        $data['action'] = $this->url->link('extension/payment/iyzico_checkout_form', 'token=' . $this->session->data['token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/payment/iyzico_checkout_form.tpl', $data));
    }
    ...
    public function update() {
        ...
        if ($updated == 1) {
            ...
            $this->response->redirect($this->url->link('extension/payment/iyzico_checkout_form', 'token=' . $this->session->data['token'] . "&update_error=$updated", true));
        }
    }
    ...
    public function order() {
        ...
        return $this->load->view('extension/payment/iyzico_checkout_form_order.tpl', $data);
    }
